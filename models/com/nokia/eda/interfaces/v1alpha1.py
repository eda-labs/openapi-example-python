...
class Breakout(BaseModel):
    ...
    spec: Annotated[
        Spec,
        Field(
            description='Breakout allowes for the configuration of interface breakouts on specified Nodes. This resource specifies the Nodes, parent Interfaces, the number of breakout channels, and the speed of each channel.',
            title='Specification',
        ),
    ]
    status: Annotated[
...
class Ethernet(BaseModel):
    fec: Annotated[
        ...
        Field(
            description='Sets the Fordward Error Correction (FEC) on the members of the interface.',
...
class Lag(BaseModel):
    lacp: Annotated[Optional[Lacp], Field(title='LACP')] = None
    minLinks: Annotated[
        Optional[int],
        Field(
    ...
    multihoming: Annotated[Optional[Multihoming], Field(title='Multi Homing')] = None
    type: Annotated[
...
class SpecModel(BaseModel):
    ...
    lag: Annotated[
        Optional[Lag], Field(description='LAG configuration options.', title='LAG')
    ] = None
    lldp: Annotated[
        Optional[bool],
        Field(
...
class Status(BaseModel):
    ...
    lag: Annotated[Optional[LagModel], Field(title='Lag')] = None
    lastChange: Annotated[
        Optional[date],
        Field(
...
class Interface(BaseModel):
    ...
    status: Annotated[Optional[Status], Field(title='Status')] = None
...
class InterfaceState(BaseModel):
    ...
    kind: str
    metadata: Metadata
    spec: Annotated[SpecModel1, Field(title='Specification')]
    status: Annotated[
        Optional[Dict[str, Any]],
        Field(
