...
class Policer(BaseModel):
    ...
    forwardingClasses: Annotated[
        Optional[List[ForwardingClassModel]],
        Field(
...
class QueueManagementItemModel(BaseModel):
    pfcReservedBufferPercent: Annotated[
        ...
        Field(
            ...
            ge=0,
            le=100,
            title='PFC Reserved Licecard Buffer Percent',
        ),
    ] = None
    pfcReservedBufferSize: Annotated[
        Optional[int],
        Field(
            description='PFC-reserved-buffer-size.',
            ge=0,
            le=4294967295,
            title='PFC Reserved Buffer Size',
        ),
    ] = None
    queues: Annotated[
