...
class DynamicLearning(BaseModel):
    ageTime: Annotated[
        Optional[int],
        Field(
...
class L2proxyARPND(BaseModel):
    dynamicLearning: Annotated[
        Optional[DynamicLearning], Field(title='Dynamic Learning')
    ] = None
    ipDuplication: Annotated[
        Optional[IpDuplication], Field(title='L2 Proxy ARP/ND IP Duplication Detection')
    ] = None
    proxyARP: Annotated[
...
class MacDuplicationDetection(BaseModel):
    action: Annotated[
...
class Spec(BaseModel):
    ...
    macDuplicationDetection: Annotated[
        Optional[MacDuplicationDetection],
        Field(
...
class BridgeInterface(BaseModel):
    ...
    status: Annotated[Optional[Status1Model], Field(title='Status')] = None
...
class EvpnRouteAdvertisementType(BaseModel):
...
class HostRoutePopulate(BaseModel):
    dynamic: Annotated[
        Optional[bool],
        Field(
...
class VirtualIPDiscoveryItem(BaseModel):
...
class SpecModel2(BaseModel):
    ...
    evpnRouteAdvertisementType: Annotated[
        Optional[EvpnRouteAdvertisementType],
        Field(
    ...
    ipAddresses: Annotated[Optional[List[IpAddress]], Field(title='IP Addresses')] = (
        None
    )
    ipMTU: Annotated[
        Optional[int],
    ...
    virtualIPDiscovery: Annotated[
        Optional[List[VirtualIPDiscoveryItem]],
        Field(
...
class IpAliasNexthop(BaseModel):
    esi: Annotated[
        Optional[str],
        Field(
...
class VLAN(BaseModel):
    ...
    status: Annotated[Optional[Status1Model4], Field(title='Status')] = None
...
class BridgeDomainModel(BaseModel):
    name: Annotated[
        str,
...
class BridgeInterfaceModel(BaseModel):
    name: Annotated[
        str,
        Field(
...
class Ipv6UnicastModel(BaseModel):
    enabled: Annotated[
        Optional[bool],
...
class Policy(BaseModel):
    ...
    spec: Annotated[
        Optional[SpecModel11], Field(description='A policy', title='Policy Spec')
    ] = None
...
class Protocols(BaseModel):
    bgp: Annotated[
        Optional[BgpModel], Field(description='BGP Protocol.', title='BGP')
    ] = None
    routingPolicies: Annotated[
        Optional[RoutingPolicies],
...
class RoutedInterfaceModel(BaseModel):
    name: Annotated[
        str,
        Field(
...
class Ipv4UnicastModel1(BaseModel):
    advertiseIPV6NextHops: Annotated[
        Optional[bool],
        Field(
            description='Enables advertisement of IPv4 Unicast routes with IPv6 next-hops to peers.',
...
class Ipv6UnicastModel1(BaseModel):
    enabled: Annotated[
        bool, Field(description='Enables the IPv6 unicast AFISAFI', title='Enabled')
    ]
    multipath: Annotated[
...
class Vlan(BaseModel):
    ...
    spec: Annotated[
        SpecModel16, Field(description='Specification of the Vlan', title='VLAN Spec')
    ]


class SpecModel17(BaseModel):
    bridgeDomains: Annotated[
        Optional[List[BridgeDomainModel]],
        Field(
            description='List of Subnets. [emits=BridgeDomain]', title='Bridge Domains'
        ),
    ] = None
    bridgeInterfaces: Annotated[
        Optional[List[BridgeInterfaceModel]],
        Field(
    ...
    routedInterfaces: Annotated[
        Optional[List[RoutedInterfaceModel]],
        Field(
...
class VirtualNetwork(BaseModel):
    ...
    status: Annotated[Optional[Status1Model5], Field(title='Status')] = None
